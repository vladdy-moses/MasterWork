...
% интервалы и отступы
\ESKDsectSkip{section}{1.5em}{1.5em}
\ESKDsectSkip{subsection}{1.5em}{1.5em}
\ESKDsectSkip{subsubsection}{1.5em}{1.5em}
...
\ESKDsignature{\WorkNumber} % обозначение документа (по п.6.1.1) 
